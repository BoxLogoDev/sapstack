...
We take security seriously. If you discover a security vulnerability in sapstack Desktop, please report it responsibly.
...
- The sapstack Desktop desktop application
- The `@sapstack-desktop/*` npm packages
- Official sapstack Desktop repositories
