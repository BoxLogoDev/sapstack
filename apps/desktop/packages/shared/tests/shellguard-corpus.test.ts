...
const TEST_MODE_CONFIG = {
  ...
  readOnlyBashPatterns: [
    ...
    // sapstack-desktop CLI read-only
    { regex: /^sapstack-desktop\s+label\s+(list|get)\b/, source: '^sapstack-desktop\\s+label\\s+(list|get)\\b', comment: 'sapstack-desktop label read-only operations' },
    { regex: /^sapstack-desktop\s+source\s+(list|get|validate|test)\b/, source: '^sapstack-desktop\\s+source\\s+(list|get|validate|test)\\b', comment: 'sapstack-desktop source read-only operations' },
    { regex: /^sapstack-desktop\s+skill\s+(list|get|validate|where)\b/, source: '^sapstack-desktop\\s+skill\\s+(list|get|validate|where)\\b', comment: 'sapstack-desktop skill read-only operations' },
    { regex: /^sapstack-desktop\s+automation\s+(list|get|validate|history|last-executed|test|lint)\b/, source: '^sapstack-desktop\\s+automation\\s+(list|get|validate|history|last-executed|test|lint)\\b', comment: 'sapstack-desktop automation read-only operations' },
    { regex: /^sapstack-desktop\s*$/, source: '^sapstack-desktop\\s*$', comment: 'sapstack-desktop bare invocation' },
    { regex: /^sapstack-desktop\s+(label|source|skill|automation)\s+--help\b/, source: '^sapstack-desktop\\s+(label|source|skill|automation)\\s+--help\\b', comment: 'sapstack-desktop entity help flags' },
    { regex: /^sapstack-desktop\s+--(help|version|discover)\b/, source: '^sapstack-desktop\\s+--(help|version|discover)\\b', comment: 'sapstack-desktop global flags' },
...
// ============================================================
// Group 27: sapstack-desktop CLI allowlist
// ============================================================

describe('ShellGuard corpus: sapstack-desktop CLI allowlist', () => {
  const shouldAllow = [
    'sapstack-desktop',
    'sapstack-desktop --help',
    'sapstack-desktop --version',
    'sapstack-desktop --discover',
    'sapstack-desktop label --help',
    'sapstack-desktop label list',
    'sapstack-desktop label get bug',
    'sapstack-desktop source --help',
    ...
    'sapstack-desktop skill --help',
    'sapstack-desktop skill list',
    'sapstack-desktop skill get commit-helper',
    'sapstack-desktop skill where commit-helper',
    'sapstack-desktop skill validate commit-helper',
    'sapstack-desktop automation list',
    'sapstack-desktop automation get abc123',
    'sapstack-desktop automation validate',
    'sapstack-desktop automation history abc123 --limit 5',
    'sapstack-desktop automation last-executed abc123',
    'sapstack-desktop automation test abc123 --match "x"',
    'sapstack-desktop automation lint',
  ];

  const shouldBlock = [
    'sapstack-desktop label create --name Bug',
    'sapstack-desktop label update bug --name "Bug Report"',
    'sapstack-desktop label delete bug',
    'sapstack-desktop label move bug --parent root',
    'sapstack-desktop label reorder --parent root a b c',
    'sapstack-desktop source create --name Linear --provider linear --type mcp',
    'sapstack-desktop source update linear --json "{\"enabled\":false}"',
    'sapstack-desktop source delete linear',
    'sapstack-desktop skill create --name "Review" --description "x"',
    'sapstack-desktop skill update review --json "{\"description\":\"y\"}"',
    'sapstack-desktop skill delete review',
    'sapstack-desktop automation create --event UserPromptSubmit --prompt "x"',
    'sapstack-desktop automation update abc123 --json "{\"enabled\":false}"',
    'sapstack-desktop automation delete abc123',
    'sapstack-desktop automation enable abc123',
    'sapstack-desktop automation disable abc123',
