 ...
 * Extracted here so handler code in @sapstack-desktop/server-core can import
 * from @sapstack-desktop/shared/protocol without reaching into the app.
 */
...
export { generateMessageId } from '@sapstack-desktop/core/types'
...
export interface TaskGenerateResult {
  ...
  slug: string
  /** Parsed TaskSpec when valid (consumers cast to TaskSpec from @sapstack-desktop/shared/tasks). */
  spec?: unknown
...
export interface TaskGetResult {
  slug: string
  validation: TaskValidationResultDto
  /** The parsed TaskSpec (from @sapstack-desktop/shared/tasks) when valid; consumers cast. */
  spec?: unknown
