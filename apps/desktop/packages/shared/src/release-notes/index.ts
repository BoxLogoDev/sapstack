 ...
 *
 * Loads release notes from bundled assets and syncs them to ~/.sapstack-desktop/release-notes/.
...
function loadBundledReleaseNotes(): Record<string, string> {
  ...
  // Try bundled assets first, fall back to ~/.sapstack-desktop/release-notes/
  // (Docker/remote server may not have SAPSTACK_DESKTOP_BUNDLED_ASSETS_ROOT set,
