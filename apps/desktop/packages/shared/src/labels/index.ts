 ...
 * For filesystem operations, import from '@sapstack-desktop/shared/labels/storage'.
 */
...
// Auto-labels: import directly from '@sapstack-desktop/shared/labels/auto' to keep
