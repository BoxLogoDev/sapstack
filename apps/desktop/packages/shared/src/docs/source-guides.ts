 ...
 * Guides are now served exclusively via the sapstack-desktops-docs MCP server.
 *
 ...
 * Use the sapstack-desktops-docs MCP server to search for setup guides.
 *
 * Example: mcp__sapstack-desktops-docs__SearchCraftAgents({ query: "github source setup guide" })
 */
