...
describe('PromptHandler', () => {
  ...
  describe('environment variable expansion', () => {
    it('should expand $VAR syntax in prompt text', async () => {
      ...
      const configProvider = createMockConfigProvider({
        LabelAdd: [{
          actions: [{ type: 'prompt', prompt: 'Label $SAPSTACK_DESKTOP_LABEL was added' }],
        }],
      });
    ...
    it('should expand ${VAR} syntax in prompt text', async () => {
      ...
      const configProvider = createMockConfigProvider({
        LabelAdd: [{
          actions: [{ type: 'prompt', prompt: 'Label ${SAPSTACK_DESKTOP_LABEL} was added to ${SAPSTACK_DESKTOP_WORKSPACE_ID}' }],
        }],
      });
