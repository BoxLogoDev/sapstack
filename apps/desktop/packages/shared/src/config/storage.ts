...
import type { StoredAttachment, StoredMessage } from '@sapstack-desktop/core/types';
...
import type { Workspace, AuthType } from '@sapstack-desktop/core/types';
...
const FALLBACK_CONFIG_DEFAULTS: ConfigDefaults = {
  version: '1.0',
  description: 'Default configuration values for sapstack Desktop',
  defaults: {
...
/**
 * Load config defaults from ~/.sapstack-desktop/config-defaults.json
...
export function ensureConfigDir(): void {
  ...
  backupConfigFile();
  // Initialize bundled docs (creates ~/.sapstack-desktop/docs/ with sources.md, agents.md, permissions.md)
  initializeDocs();
...
export type { StoredAttachment, StoredMessage } from '@sapstack-desktop/core/types';
...
/**
 * Get the path to the app-level theme override file (~/.sapstack-desktop/theme.json).
 */
 ...
 * Preset themes are stored at ~/.sapstack-desktop/themes/
 */
...
/**
 * Returns the path to the tool-icons directory: ~/.sapstack-desktop/tool-icons/
 */
