 ...
 *
 * Watched paths:
 * - ~/.sapstack-desktop/config.json - Main app configuration
 * - ~/.sapstack-desktop/preferences.json - User preferences
 * - ~/.sapstack-desktop/theme.json - App-level theme overrides
 * - ~/.sapstack-desktop/themes/*.json - Preset theme files (app-level)
 * - ~/.sapstack-desktop/workspaces/{slug}/ - Workspace directory (recursive)
...
export interface ConfigWatcherCallbacks {
  ...
  /** Called when app-level default permissions change (~/.sapstack-desktop/permissions/default.json) */
...
export class ConfigWatcher {
  ...
  /**
   * Watch app-level themes directory (~/.sapstack-desktop/themes/)
   */
  ...
  /**
   * Watch app-level permissions directory (~/.sapstack-desktop/permissions/)
