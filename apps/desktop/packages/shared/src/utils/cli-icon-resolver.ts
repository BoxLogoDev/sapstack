 ...
 *
 * The mapping lives in ~/.sapstack-desktop/tool-icons/tool-icons.json alongside the
 ...
 *
 * @param toolIconsDir - Path to the tool-icons directory (e.g. ~/.sapstack-desktop/tool-icons/)
 ...
 *
 * @param commandStr - Full bash command string, e.g. "git add . && npm publish"
 * @param toolIconsDir - Path to ~/.sapstack-desktop/tool-icons/ containing tool-icons.json and icon files
