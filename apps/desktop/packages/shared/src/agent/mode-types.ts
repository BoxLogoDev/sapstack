 ...
 *
 * The actual patterns are loaded from ~/.sapstack-desktop/permissions/default.json
 * at runtime by PermissionsConfigCache. This fallback ensures the app works
 * even if the JSON file is missing or invalid.
 *
 * To customize allowed commands, edit ~/.sapstack-desktop/permissions/default.json
 */
