...
declare const SAPSTACK_DESKTOP_AGENT_CLI_VERSION: string | undefined;
...
export function getDefaultOptions(envOverrides?: Record<string, string>): Partial<Options> {
    ...
    if (typeof SAPSTACK_DESKTOP_AGENT_CLI_VERSION !== 'undefined' && SAPSTACK_DESKTOP_AGENT_CLI_VERSION != null) {
        const baseDir = join(homedir(), '.local', 'share', 'craft', 'versions', SAPSTACK_DESKTOP_AGENT_CLI_VERSION);
        return {
