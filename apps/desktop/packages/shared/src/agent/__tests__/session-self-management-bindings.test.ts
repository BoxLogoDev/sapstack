...
import type { SessionToolContext, SessionInfo } from '@sapstack-desktop/session-tools-core';
import { SESSION_TOOL_REGISTRY } from '@sapstack-desktop/session-tools-core';
