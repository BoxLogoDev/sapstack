...
import type { PushTarget } from '@sapstack-desktop/shared/protocol'
import type { CredentialManager } from '@sapstack-desktop/shared/credentials'
import type {
  ISessionManager,
...
export interface MessagingGatewayRegistryOptions {
  ...
  whatsapp?: {
    /** Absolute path to the worker entry (packaged/unpacked from @sapstack-desktop/messaging-whatsapp-worker). */
    workerEntry: string
