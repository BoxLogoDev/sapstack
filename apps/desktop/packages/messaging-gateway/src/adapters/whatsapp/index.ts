 ...
 * `@sapstack-desktop/messaging-whatsapp-worker` subprocess.
 *
 ...
 *
 * The worker contract is defined in @sapstack-desktop/messaging-whatsapp-worker.
...
import {
  ...
  type WorkerCommand,
  type WorkerEvent,
} from '@sapstack-desktop/messaging-whatsapp-worker'
import type {
  PlatformAdapter,
  PlatformConfig,
  AdapterCapabilities,
