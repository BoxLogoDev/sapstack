import type { AgentProvider, LlmAuthType } from '@sapstack-desktop/shared/agent/backend'
import { isCompatProvider, modelSupportsImages, type LlmConnection } from '@sapstack-desktop/shared/config'
import type { FileAttachment } from '@sapstack-desktop/shared/protocol'
