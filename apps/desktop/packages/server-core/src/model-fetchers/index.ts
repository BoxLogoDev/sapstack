...
import type { ModelFetcherMap, ModelFetcherCredentials, FetchableProvider } from '@sapstack-desktop/shared/config'
import type { ModelDefinition } from '@sapstack-desktop/shared/config'
import {
  getLlmConnections,
  getLlmConnection,
  updateLlmConnection,
