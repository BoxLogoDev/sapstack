...
import type { Workspace, WorkspaceInfo, ActiveSessionInfo } from '@sapstack-desktop/core/types'
import type { StoredAttachment, AnnotationV1 } from '@sapstack-desktop/core/types'
import type { PermissionMode } from '@sapstack-desktop/shared/agent/mode-types'
import type { ThinkingLevel } from '@sapstack-desktop/shared/agent/thinking-levels'
import type { AuthResult } from '@sapstack-desktop/shared/agent'
import type {
  Session,
  SessionStatus,
...
import type { SessionBundle, DispatchMode } from '@sapstack-desktop/shared/sessions'
...
export interface ISessionManager {
  ...
  exportRemoteSessionTransfer(
    sessionId: string,
    workspaceId: string,
  ): Promise<import('@sapstack-desktop/shared/protocol').RemoteSessionTransferPayload | null>
  ...
  importRemoteSessionTransfer(
    workspaceId: string,
    payload: import('@sapstack-desktop/shared/protocol').RemoteSessionTransferPayload,
  ): Promise<import('@sapstack-desktop/shared/protocol').ImportRemoteSessionTransferResult>
...
export interface ExecutePromptAutomationInput {
   ...
   * doesn't trip the RPC client timeout (sapstack-desktops-oss#943). The session
