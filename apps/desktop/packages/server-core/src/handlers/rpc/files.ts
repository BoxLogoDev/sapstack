...
import { RPC_CHANNELS, type FileAttachment, type DirectoryListingResult } from '@sapstack-desktop/shared/protocol'
import type { StoredAttachment } from '@sapstack-desktop/core/types'
import { readFileAttachment, validateImageForClaudeAPI, IMAGE_LIMITS } from '@sapstack-desktop/shared/utils'
import { getSessionAttachmentsPath, validateSessionId } from '@sapstack-desktop/shared/sessions'
import { getWorkspaceByNameOrId } from '@sapstack-desktop/shared/config'
import { resizeImageForAPI, inspectImageBuffer } from '@sapstack-desktop/server-core/services'
import { sanitizeFilename, validateFilePath, getWorkspaceAllowedDirs } from '@sapstack-desktop/server-core/handlers'
