...
import { addWorkspace, setActiveWorkspace } from '@sapstack-desktop/shared/config'
import { getDefaultWorkspacesDir, ensureDefaultWorkspacesDir } from '@sapstack-desktop/shared/workspaces'
import type { ServerStatus, ServerHealth } from '@sapstack-desktop/core/types'
