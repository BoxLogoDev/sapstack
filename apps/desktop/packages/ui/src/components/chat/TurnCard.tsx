...
import type { ToolDisplayMeta, AnnotationV1 } from '@sapstack-desktop/core'
import { normalizePath, pathStartsWith, stripPathPrefix } from '@sapstack-desktop/core/utils'
