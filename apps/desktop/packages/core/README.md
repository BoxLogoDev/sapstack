# @sapstack-desktop/core

Shared TypeScript types and utilities for sapstack Desktop applications.

## Installation

```bash
# In a workspace package
bun add @sapstack-desktop/core
```
...
{
  "dependencies": {
    "@sapstack-desktop/core": "workspace:*"
  }
}
```
...
import type {
  ...
  TokenUsage,
  AgentEvent,
} from '@sapstack-desktop/core';

// Import utilities
import { generateMessageId, debug } from '@sapstack-desktop/core';
```
