...
export interface SessionToolContext {
  ...
  /** Absolute path to workspace folder (~/.sapstack-desktop/workspaces/{id}) */
   ...
   * - Claude: writes JSON files to ~/.sapstack-desktop/feedback/
  ...
  /**
   * Create a sapstack Desktop Task (board card + task.yaml + orchestrator session)
...
export interface ResolvedLabelsResult {
   ...
   * Populated by `resolveSessionLabels()` from `@sapstack-desktop/shared/labels`.
