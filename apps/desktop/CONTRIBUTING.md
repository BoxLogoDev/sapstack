# Contributing to sapstack Desktop

Thank you for your interest in contributing to sapstack Desktop! This document provides guidelines and instructions for contributing.
...
└── packages/
    ├── core/        # @sapstack-desktop/core - Shared types
    ├── shared/      # @sapstack-desktop/shared - Business logic
    └── ui/          # @sapstack-desktop/ui - React components
```
