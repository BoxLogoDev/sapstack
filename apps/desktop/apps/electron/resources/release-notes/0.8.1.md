...
- **Docker defaults** — Fixed Dockerfile and Compose defaults around `.sapstack-desktop` directory ownership, ports, and volume behavior for self-hosted server setups.
