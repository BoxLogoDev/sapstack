...
## Bug Fixes
- **WebUI Google OAuth redirect mismatch** — Fixed `redirect_uri_mismatch` in WebUI by using a stable provider-facing callback (`https://boxlogodev.github.io/sapstack/auth/callback`) and relaying the real target through state.
