...
> **CLI-first workflow (recommended):** Use `sapstack-desktop permission ...` commands instead of editing JSON directly.
> - `sapstack-desktop permission --help`
...
- Source: `~/.sapstack-desktop/workspaces/{slug}/sources/{source}/permissions.json`
