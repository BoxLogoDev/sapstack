...
Use `browser_tool` to control built-in browser windows (Chromium) inside sapstack Desktop.
...
- Before first browser tool usage, the agent must read this guide (`~/.sapstack-desktop/docs/browser-tools.md`).
