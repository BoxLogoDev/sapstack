...
This folder contains assets that are bundled with the Electron app and synced to the user's `~/.sapstack-desktop/` directory on every launch.
...
|-------------|-----------|---------------|
| `docs/` | `~/.sapstack-desktop/docs/` | Always overwrite on launch |
| `themes/` | `~/.sapstack-desktop/themes/` | Always overwrite on launch |
| `permissions/` | `~/.sapstack-desktop/permissions/` | Always overwrite on launch |
| `tool-icons/` | `~/.sapstack-desktop/tool-icons/` | Always overwrite on launch |
| `release-notes/` | `~/.sapstack-desktop/release-notes/` | Always overwrite on launch |
| `config-defaults.json` | `~/.sapstack-desktop/config-defaults.json` | Always overwrite on launch |
