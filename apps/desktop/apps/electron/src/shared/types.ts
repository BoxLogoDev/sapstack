...
// =============================================================================
export * from '@sapstack-desktop/shared/protocol'
...
import type { PermissionMode } from '@sapstack-desktop/shared/agent/modes';
export type { PermissionMode };
export { PERMISSION_MODE_CONFIG } from '@sapstack-desktop/shared/agent/modes';

// Thinking level types
import type { ThinkingLevel } from '@sapstack-desktop/shared/agent/thinking-levels';
export type { ThinkingLevel };
export { THINKING_LEVELS, DEFAULT_THINKING_LEVEL } from '@sapstack-desktop/shared/agent/thinking-levels';
...
import type { AuthState, SetupNeeds } from '@sapstack-desktop/shared/auth/types';
import type { AuthType } from '@sapstack-desktop/shared/config/types';
export type { AuthState, SetupNeeds, AuthType };

// Credential health types
import type { CredentialHealthStatus, CredentialHealthIssue, CredentialHealthIssueType } from '@sapstack-desktop/shared/credentials/types';
...
import type { LoadedSource, FolderSourceConfig, SourceConnectionStatus } from '@sapstack-desktop/shared/sources/types';
export type { LoadedSource, FolderSourceConfig, SourceConnectionStatus };

// Skill types
import type { LoadedSkill, SkillMetadata } from '@sapstack-desktop/shared/skills/types';
export type { LoadedSkill, SkillMetadata };

// Resource bundle types (cross-workspace export/import)
import type { ExportResourcesOptions, ExportResult, ResourceImportMode, ResourceBundle, ResourceImportResult } from '@sapstack-desktop/shared/resources';
export type { ExportResourcesOptions, ExportResult, ResourceImportMode, ResourceBundle, ResourceImportResult };

// LLM connection types
import type { LlmConnection, LlmConnectionWithStatus, LlmAuthType, LlmProviderType, NetworkProxySettings } from '@sapstack-desktop/shared/config';
...
import type { WorkspaceInfo, Workspace, SessionMetadata, StoredAttachment as StoredAttachmentType } from '@sapstack-desktop/core/types';
...
} from '@sapstack-desktop/shared/protocol'
...
export interface ElectronAPI {
  ...
  getServerConfig(): Promise<import('@sapstack-desktop/shared/config/server-config').ServerConfig>
  setServerConfig(config: import('@sapstack-desktop/shared/config/server-config').ServerConfig): Promise<void>
  getServerStatus(): Promise<import('@sapstack-desktop/shared/config/server-config').ServerStatus>
  ...
  getDraft(sessionId: string): Promise<import('@sapstack-desktop/shared/config').SessionDraft | null>
  setDraft(sessionId: string, draft: import('@sapstack-desktop/shared/config').SessionDraft): Promise<void>
  deleteDraft(sessionId: string): Promise<void>
  getAllDrafts(): Promise<Record<string, import('@sapstack-desktop/shared/config').SessionDraft>>
  ...
  getSourcePermissionsConfig(workspaceId: string, sourceSlug: string): Promise<import('@sapstack-desktop/shared/agent').PermissionsConfigFile | null>
  getWorkspacePermissionsConfig(workspaceId: string): Promise<import('@sapstack-desktop/shared/agent').PermissionsConfigFile | null>
  getDefaultPermissionsConfig(): Promise<{ config: import('@sapstack-desktop/shared/agent').PermissionsConfigFile | null; path: string }>
  ...
  listStatuses(workspaceId: string): Promise<import('@sapstack-desktop/shared/statuses').StatusConfig[]>
  ...
  listLabels(workspaceId: string): Promise<import('@sapstack-desktop/shared/labels').LabelConfig[]>
  createLabel(workspaceId: string, input: import('@sapstack-desktop/shared/labels').CreateLabelInput): Promise<import('@sapstack-desktop/shared/labels').LabelConfig>
  ...
  listViews(workspaceId: string): Promise<import('@sapstack-desktop/shared/views').ViewConfig[]>
  saveViews(workspaceId: string, views: import('@sapstack-desktop/shared/views').ViewConfig[]): Promise<void>
  ...
  createProject(workspaceId: string, input: import('@sapstack-desktop/shared/projects/types').CreateProjectInput): Promise<import('@sapstack-desktop/shared/projects/types').ProjectConfig>
  updateProject(workspaceId: string, projectSlug: string, patch: Partial<Omit<import('@sapstack-desktop/shared/projects/types').ProjectConfig, 'id' | 'slug' | 'createdAt'>>): Promise<import('@sapstack-desktop/shared/projects/types').ProjectConfig>
  ...
  uploadProjectAsset(workspaceId: string, projectSlug: string, input: { filename: string; base64?: string; text?: string; sourcePath?: string }): Promise<import('@sapstack-desktop/shared/projects/types').ProjectAsset>
 ...
 * Mirrors the canonical type in `@sapstack-desktop/messaging-gateway`.
 */
...
declare global {
  interface Window {
    ...
    sapstack: {
      ...
      knowledge: {
        resolveSymptom(args: unknown): Promise<unknown>
        checkTcode(tcode: string): Promise<unknown>
        resolveSapNote(keyword: string): Promise<unknown>
        lookupSynonym(term: string): Promise<unknown>
        getPrompt(name: string, args?: Record<string, unknown>): Promise<string>
      }
      sessions: {
        start(input: unknown): Promise<unknown>
        addEvidence(input: unknown): Promise<unknown>
        submitHypotheses(input: unknown): Promise<unknown>
        addFollowup(input: unknown): Promise<unknown>
        submitVerdict(input: unknown): Promise<unknown>
