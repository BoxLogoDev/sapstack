...
import { Icon_Home, Spinner } from '@sapstack-desktop/ui'
...
import type { LabelConfig } from '@sapstack-desktop/shared/labels'
import { parseMentions } from '@/lib/mentions'
import { RichTextInput, type RichTextInputHandle } from '@/components/ui/rich-text-input'
import { Tooltip, TooltipContent, TooltipTrigger } from '@sapstack-desktop/ui'
import {
  DropdownMenu,
  DropdownMenuTrigger,
  DropdownMenuSub,
...
import { type ThinkingLevel, THINKING_LEVELS, getThinkingLevelNameKey } from '@sapstack-desktop/shared/agent/thinking-levels'
      ...
      >
        ...
        <div className="relative">
          ...
          {/* Compact mode: permission mode drawer + standard icon badges for attach/sources/working dir.
              ...
              anchored to the right (sapstack-desktops-oss#798). overflow-hidden is safe — Radix Drawer /
