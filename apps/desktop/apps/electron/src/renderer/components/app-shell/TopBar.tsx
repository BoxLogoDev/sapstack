...
import { Tooltip, TooltipTrigger, TooltipContent } from "@sapstack-desktop/ui"
      ...
      <div ref={rightSlotRef} className="flex min-w-0 shrink-0 items-center justify-end gap-1" style={{ paddingRight: 12 }}>
        ...
        <DropdownMenu>
          ...
          <StyledDropdownMenuContent align="end" minWidth="min-w-48">
            ...
            {window.electronAPI.featureFlags?.messaging && (
            ...
            <StyledDropdownMenuSeparator />
            <StyledDropdownMenuItem onClick={() => window.electronAPI.openUrl('https://boxlogodev.github.io/sapstack/docs')}>
