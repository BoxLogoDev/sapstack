...
import { extractLabelId } from '@sapstack-desktop/shared/labels'
...
import { SapGoldenPath } from './SapGoldenPath'
...
export function MainContentPanel({
  ...
  if (isSessionsNavigation(navState)) {
    ...
    // No session selected - SAP operator Golden Path
    return wrapWithStoplight(
      <Panel variant="grow" className={className}>
        <SapGoldenPath onOpenChat={openNewChat} />
      </Panel>
    )
  }
