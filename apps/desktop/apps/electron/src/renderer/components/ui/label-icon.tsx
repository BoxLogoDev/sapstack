...
import type { IconSize } from '@sapstack-desktop/shared/icons'
import type { EntityColor } from '@sapstack-desktop/shared/colors'
...
interface LabelIconProps {
  /** Label configuration (matches LabelConfig from @sapstack-desktop/shared/labels) */
  label: {
    id: string
