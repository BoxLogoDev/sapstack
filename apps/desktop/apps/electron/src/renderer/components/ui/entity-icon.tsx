...
import type { ResolvedEntityIcon, IconSize } from '@sapstack-desktop/shared/icons'
import { ICON_SIZE_CLASSES, ICON_EMOJI_SIZES } from '@sapstack-desktop/shared/icons'
