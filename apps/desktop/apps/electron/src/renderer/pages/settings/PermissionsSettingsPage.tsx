 ...
 * Shows both default patterns (from ~/.sapstack-desktop/permissions/default.json)
 * and custom workspace additions (from workspace permissions.json).
 *
 * Default patterns can be edited by the user in ~/.sapstack-desktop/permissions/default.json.
...
import { type PermissionsConfigFile } from '@sapstack-desktop/shared/agent/modes'
import {
...
import { getDocUrl } from '@sapstack-desktop/shared/docs/doc-links'
...
/**
 * Build default permissions data from ~/.sapstack-desktop/permissions/default.json.
