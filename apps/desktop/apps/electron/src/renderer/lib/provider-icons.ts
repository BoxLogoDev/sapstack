...
import type { LlmProviderType } from '@sapstack-desktop/shared/config/llm-connections'
...
const providerDisplayNames: Record<string, string> = {
  ...
  pi: 'sapstack Desktop Agent Runtime',
  pi_compat: 'sapstack Desktop Agent Runtime',
  vercel: 'Vercel',
}
