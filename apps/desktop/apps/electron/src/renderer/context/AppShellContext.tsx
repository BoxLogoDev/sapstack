...
export interface AppShellContextType {
  ...
  getDraftAttachmentRefs: (sessionId: string) => import('@sapstack-desktop/shared/config').DraftAttachmentRef[]
  ...
  onSendMessage: (sessionId: string, message: string, attachments?: FileAttachment[], skillSlugs?: string[], badges?: import('@sapstack-desktop/core').ContentBadge[]) => void
