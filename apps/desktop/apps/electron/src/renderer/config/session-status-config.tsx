...
import type { StatusConfig } from '@sapstack-desktop/shared/statuses'
import { isEmoji } from '@sapstack-desktop/shared/utils/icon-constants'
import { resolveEntityColor, getDefaultStatusColor } from '@sapstack-desktop/shared/colors'
