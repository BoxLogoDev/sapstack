...
export const iconComponents: ComponentEntry[] = [
  {
    id: 'sapstack-desktops-logo',
    name: 'CraftAgentsLogo',
    category: 'Icons',
    description: 'Full sapstack Desktop branding logo with text',
  ...
  {
    id: 'sapstack-desktops-symbol',
    name: 'CraftAgentsSymbol',
    category: 'Icons',
    description: 'sapstack Desktop "E" pixel art symbol icon (brand color: #9570BE)',
