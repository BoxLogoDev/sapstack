...
import { TurnCard, type ActivityItem } from '@sapstack-desktop/ui'
...
function InputContainerPlayground({
  disabled = false,
  isProcessing = false,
  placeholder = 'Message sapstack Desktop...',
  currentModel = 'claude-sonnet-4-6',
  permissionMode = 'ask',
  workingDirectory = '/Users/demo/projects/sapstack-desktop',
  inputMode = 'freeform',
  compactMode = false,
  ...
  },
  {
    ...
    props: [
      ...
      },
      {
        ...
        defaultValue: 'Message sapstack Desktop...',
      },
      {
        name: 'currentModel',
      ...
      },
      {
        ...
        defaultValue: '/Users/demo/projects/sapstack-desktop',
      },
      {
        name: 'seedRecentDirs',
