...
function getLiveFxPayload(scenario: Scenario, runState: RunState): { active: boolean; label: string; cursor: { x: number; y: number } | null } {
  ...
  if (runState === 'running') {
    ...
    return {
      active: true,
      label: 'sapstack Desktop are working…',
...
const MOCK_BROWSER_PRESETS: Record<BrowserTabStripMockPreset, BrowserInstanceInfo[]> = {
  default: [
    ...
    {
      id: 'mock-4',
      url: 'https://github.com/lukilabs/sapstack-desktops-oss',
      title: 'GitHub',
      favicon: null,
      isLoading: false,
      canGoBack: true,
  ...
  'long-names': [
    {
      ...
      title: 'sapstack Desktop Multi-Session Browser Registry Design Review Thread (Q1 2026)',
      favicon: null,
      isLoading: false,
      canGoBack: true,
      canGoForward: true,
  ...
  'many-running': [
    ...
    {
      id: 'run-3',
      url: 'https://github.com/lukilabs/sapstack-desktops-oss/pulls',
      title: 'GitHub PRs',
      favicon: null,
      isLoading: true,
      canGoBack: false,
  ...
  'stress-mix': [
    ...
    },
    {
      id: 'mix-4',
      url: 'https://github.com/lukilabs/sapstack-desktops-oss',
      title: 'sapstack Desktop OSS Repo with a Surprisingly Long Branch and Compare View Name',
      favicon: null,
      isLoading: false,
      canGoBack: true,
      canGoForward: true,
