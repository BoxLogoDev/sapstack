...
const mockAutomations: AutomationListItem[] = [
  ...
  },
  {
    ...
    enabled: true,
    actions: [{ type: 'prompt', prompt: 'Log the label change: "$SAPSTACK_DESKTOP_LABEL was added" to ~/label-log.txt' }],
    permissionMode: 'allow-all',
  ...
  },
  {
    ...
    actions: [{ type: 'prompt', prompt: 'Session $SAPSTACK_DESKTOP_SESSION_NAME was marked as done. Summarise what was accomplished.' }],
