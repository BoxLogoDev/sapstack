...
mock.module('@sapstack-desktop/shared/config', () => ({
...
mock.module('@sapstack-desktop/shared/workspaces', () => ({
  loadWorkspaceConfig: () => ({
    defaults: {
      permissionMode: 'ask',
      thinkingLevel: 'medium',
...
mock.module('@sapstack-desktop/shared/agent', () => ({
...
mock.module('@sapstack-desktop/shared/agent/backend', () => ({
...
mock.module('@sapstack-desktop/shared/sources', () => ({
...
mock.module('@sapstack-desktop/shared/automations', () => ({
...
mock.module('@sapstack-desktop/shared/sessions', () => ({
  listSessions: () => [],
...
const { SessionManager } = await import('@sapstack-desktop/server-core/sessions')
