...
import { groupMessagesByTurn, type AssistantTurn } from '@sapstack-desktop/ui/chat/turn-utils'
import { messageToStored, storedToMessage } from '@sapstack-desktop/core'
import type { Message, MessageRole } from '@sapstack-desktop/core'
