...
export class WindowManager {
  ...
  private eventSink: ((channel: string, target: import('@sapstack-desktop/shared/protocol').PushTarget, ...args: any[]) => void) | null = null
   ...
   */
  setRpcEventSink(
    sink: (channel: string, target: import('@sapstack-desktop/shared/protocol').PushTarget, ...args: any[]) => void,
  ...
  getRpcEventSink(): ((channel: string, target: import('@sapstack-desktop/shared/protocol').PushTarget, ...args: any[]) => void) | null {
   ...
   *   1 window  → app name ("sapstack Desktop") on the lone window
  ...
  createWindow(options: CreateWindowOptions): BrowserWindow {
    ...
    // The renderer's index.html ships with `<title>sapstack Desktop</title>`, so
