...
import { getNetworkProxySettings, setNetworkProxySettings } from '@sapstack-desktop/shared/config/storage';
import type { NetworkProxySettings } from '@sapstack-desktop/shared/config/types';
