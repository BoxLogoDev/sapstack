...
async function getExpectedChannels(): Promise<Set<string>> {
  ...
  const [
    ...
    import('@sapstack-desktop/server-core/handlers/rpc/auth'),
    import('@sapstack-desktop/server-core/handlers/rpc/automations'),
    import('@sapstack-desktop/server-core/handlers/rpc/files'),
    import('@sapstack-desktop/server-core/handlers/rpc/labels'),
    import('@sapstack-desktop/server-core/handlers/rpc/llm-connections'),
    import('@sapstack-desktop/server-core/handlers/rpc/oauth'),
    import('@sapstack-desktop/server-core/handlers/rpc/sessions'),
    import('@sapstack-desktop/server-core/handlers/rpc/settings'),
    import('@sapstack-desktop/server-core/handlers/rpc/skills'),
    import('@sapstack-desktop/server-core/handlers/rpc/sources'),
    import('@sapstack-desktop/server-core/handlers/rpc/statuses'),
    import('@sapstack-desktop/server-core/handlers/rpc/system'),
    import('@sapstack-desktop/server-core/handlers/rpc/workspace'),
    import('@sapstack-desktop/server-core/handlers/rpc/onboarding'),
    import('@sapstack-desktop/server-core/handlers/rpc/resources'),
    import('@sapstack-desktop/server-core/handlers/rpc/transfer'),
    import('@sapstack-desktop/server-core/handlers/rpc/tasks'),
    import('@sapstack-desktop/server-core/handlers/rpc/projects'),
  ])
...
describe('RPC handler registration', () => {
  ...
  it('keeps onboarding channels in registration coverage', async () => {
    const { HANDLED_CHANNELS } = await import('@sapstack-desktop/server-core/handlers/rpc/onboarding')
    const { registerAllRpcHandlers } = await import('../index')
