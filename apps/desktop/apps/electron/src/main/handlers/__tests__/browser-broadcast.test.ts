 ...
 * sapstack Desktop window's id (set by updateClientWorkspace), but remote-bridged
...
import type { BrowserInstanceInfo } from '@sapstack-desktop/shared/protocol'
...
describe('browser handler — workspace filtering', () => {
  ...
  describe('LIST handler', () => {
    ...
    it('returns ALL instances regardless of ctx.workspaceId (renderer filters)', async () => {
      ...
      // local sapstack Desktop window's workspace id, but remote-bridged tabs are
