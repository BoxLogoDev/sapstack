...
export default [
  ...
  // TypeScript/React files
  {
    ...
    plugins: {
      ...
      // Custom plugin for sapstack Desktop rules
      'sapstack-desktop': {
        rules: {
    ...
    rules: {
      ...
      // Custom sapstack Desktop rules
      'sapstack-desktop/no-direct-navigation-state': 'error',
      'sapstack-desktop/no-localstorage': 'warn',
  ...
  // Enforce backend abstraction boundary in Electron main process.
  {
    ...
    rules: {
      'no-restricted-imports': ['error', {
        paths: [
          {
            name: '@sapstack-desktop/shared/codex',
            message: 'Use provider-agnostic APIs from @sapstack-desktop/shared/agent/backend instead.',
          },
          {
            name: '@sapstack-desktop/shared/agent/claude-agent',
            message: 'Provider backends must stay behind @sapstack-desktop/shared/agent/backend.',
          },
          {
            name: '@sapstack-desktop/shared/agent/pi-agent',
            message: 'Provider backends must stay behind @sapstack-desktop/shared/agent/backend.',
          },
        ],
      }],
      ...
      'no-restricted-syntax': ['error',
        {
          ...
          message: 'Do not call provider APIs directly in Electron model fetchers. Delegate to fetchBackendModels() from @sapstack-desktop/shared/agent/backend.',
        },
        {
