#!/usr/bin/env bash
# install-server.sh — Set up the sapstack Desktop standalone server.
#
# Usage:
...
echo ""
echo "===================================="
echo "  sapstack Desktop Server Ready"
echo "===================================="
echo ""
echo "Start the server (with Web UI):"
echo ""
echo "  SAPSTACK_DESKTOP_SERVER_TOKEN=$TOKEN \\"
echo "  SAPSTACK_DESKTOP_WEBUI_DIR=$REPO_ROOT/apps/webui/dist \\"
echo "  SAPSTACK_DESKTOP_BUNDLED_ASSETS_ROOT=$REPO_ROOT/apps/electron \\"
...
echo "  SAPSTACK_DESKTOP_WEBUI_DIR=$REPO_ROOT/apps/webui/dist \\"
echo "  SAPSTACK_DESKTOP_BUNDLED_ASSETS_ROOT=$REPO_ROOT/apps/electron \\"
echo "  SAPSTACK_DESKTOP_RPC_HOST=0.0.0.0 \\"
echo "  SAPSTACK_DESKTOP_RPC_PORT=9100 \\"
echo "  bun run $REPO_ROOT/packages/server/src/index.ts"
echo ""
...
echo "  SAPSTACK_DESKTOP_WEBUI_DIR=$REPO_ROOT/apps/webui/dist \\"
echo "  SAPSTACK_DESKTOP_BUNDLED_ASSETS_ROOT=$REPO_ROOT/apps/electron \\"
echo "  SAPSTACK_DESKTOP_RPC_TLS_CERT=/path/to/cert.pem \\"
echo "  SAPSTACK_DESKTOP_RPC_TLS_KEY=/path/to/key.pem \\"
echo "  bun run $REPO_ROOT/packages/server/src/index.ts"
echo ""
