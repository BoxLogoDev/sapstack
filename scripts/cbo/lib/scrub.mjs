 ...
 * - 자동 마스킹: 주민등록번호(6-7, 성별자리 검증) / 신용카드(4-4-4-4) / 사업자번호(3-2-5) / 미국 SSN(3-2-4)
...
const MASK_PATTERNS = [
  ...
  // 미국 SSN(3-2-4, 하이픈 필수 — 무효 구간 000/666/9xx 제외). 글로벌 단일 인스턴스에 미국 법인 데이터가 섞인다
  { kind: 'us_ssn', re: /\b(?!000|666|9\d\d)\d{3}-(?!00)\d{2}-(?!0000)\d{4}\b/g },
