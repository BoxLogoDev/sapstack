...
| 🖥 **데스크톱 운영** | [설치](docs/desktop-install.md) → [프로비저닝](docs/provisioning.md) → [CBO 스냅샷](docs/cbo-snapshot.md) → [Microsoft 로그인](docs/entra-signin.md) → [변경 요청서](docs/change-requests.md) |
