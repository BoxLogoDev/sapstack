...
### 🌐 다국어 지원 (v1.7.0 — 6개 언어)
| 언어 | symptom-index | synonyms | UI i18n | 상태 |
|---|---|---|---|---|
| 🇰🇷 한국어 (ko) | 62/62 | 80+ | 완전 | Primary |
| 🇬🇧 English (en) | 62/62 | 80+ | 완전 | Full |
| 🇨🇳 中文 (zh) | 62/62 | 40+ | 완전 | 🆕 v1.7 |
| 🇯🇵 日本語 (ja) | 62/62 | 40+ | 완전 | 🆕 v1.7 |
| 🇩🇪 Deutsch (de) | 62/62 | 40+ | 완전 | 🆕 v1.7 |
| 🇻🇳 Tiếng Việt (vi) | 62/62 | 40+ | 완전 | 🆕 v1.7 |
...
- 🔧 **에이전트 정비** — basis→consultant, abap→developer, cloud-consultant 신규
