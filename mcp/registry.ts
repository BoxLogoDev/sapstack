...
export const TOOL_REGISTRY: readonly ToolDefinition[] = [
  ...
  { name: "start_session", description: "Start a canonical Evidence Loop session", inputSchema: objectSchema({ symptom: string(), reporter_role: string(), country_iso: string(), release: string(), deployment: string(), industry: string(), client: string(), language: string() }, ["symptom"]), invoke: (r, a) => r.sessions.start(a) },
